                    ...
                    <div key={key} class="feed-card__item">
                        <div class="card-position">
                                    ...
                                    <span class='feed-card__item__body__text'>
                                        {!showPost ?
                                            <div>
                                                ...
                                                <div>
                                                    <span class="show-full-post" onclick={() => { showPost = true, Fn.init() }}>Показать все</span>
                                                </div>
                                            </div> :

                                            <div>
                                                <span>
                                                    <p class="feed-card__item__body__text feed-card__item__body__text_white-space"
                            ...
                            <div style="padding-left: 20px;
                                ...
                                <span class="feed-card__statistic__date">
                                ...
                                <div class="feed-card__statistic__item">
                                    <div style="display: flex;
                                        ...
                                        <div class="feed-card__statistic__item__counter">
