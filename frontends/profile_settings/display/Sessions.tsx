                ...
                <table class="listExchange__table table">
                    <thead class="listExchange__table-head">
                        <tr class="listExchange__table-row">
                            <th class="listExchange__table-name disable-table-name" style="justify-content: start;">Браузер</th>
                            <th class="listExchange__table-coins disable-table-name">Платформа</th>
                            <th class="listExchange__table-coins disable-table-name">Действия</th>
                        </tr>
                    </thead>
                                        ...
                                        <div class="body-card">
                                            <div class="body-card__container">
                                                <div class="body-card__container__main-block" style="flex-direction: column">
                                                    <div class="body-card__container_font-size pt-10">{item?.info?.browser}</div>
                                                    <div class="body-card__container_font-size pt-20 coins_wrap">{item?.info?.platform}</div>
                                                </div>
