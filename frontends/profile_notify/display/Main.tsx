    ...
    <div class="page !pt-0">
      <div id="notifications" class="wrapper">
        ...
        <div class="mt-[10px] w-full rounded-[5px] p-6 !pb-0 text-[16px] font-bold leading-[20px] text-[--white] [background:#2e3340]">
          ...
          <ul class="mt-[30px] flex justify-between">
            <li
              class={[
          ...
          <div id="inner">
            <ul>
              {Static.actualNotify?.map((item) => {
                return (
                  <li class="cursor-pointer p-[20px_25px_20px_25px] [transition:0.5s] hover:[background:#3E4354]">
                    <div id="wrapper">
                      <div class="flex items-center">
                        <img class="mr-[10px] h-[25px]" src={question} />
