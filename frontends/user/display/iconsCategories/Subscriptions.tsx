    ...
    <div class="relative top-[.125rem] cursor-pointer [padding:0_15px_9px_15px]">
      <i
        ...
        class={`block h-[2.625rem] w-[2.875rem] @464:h-[4.0625rem] @464:w-[4.4375rem] ${
          Static.subscriptions === true
            ? "[background:no-repeat_url('/contents/svg/sections/friends.svg')_center_/_100%]"
            : "[background:no-repeat_url('/contents/svg/sections/friends_inactive.svg')_center_/_100%]"
        }`}
