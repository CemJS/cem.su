    ...
    return (
        <div class="modal-recover__page" ref="slidePage">
            <div class="f-col">
                ...
                <div class={[
                    "modalWindow_field",
                    Static.form.emailOrNickName.value.length ? "modalWindow_field__valid" : null,
                    Static.form.emailOrNickName.error ? "modalWindow_field__error" : null,
                    Static.form.emailOrNickName.valid ? "modalWindow_field__success" : null,
                ]}>
                    <input
                        type="text"
                        required
...
const Step3 = function () {
    return (
        <div class="modal-recover__page">
            <div class="modalReg_form">
                <h3 class="modalReg_page-title text-center">Поздравляем, Вы успешно сменили пароль!</h3>
    ...
    return (
        <main class="modal_main">
            ...
            <div class="w100 overflow-hidden">
                <div class="modal-recover__line mt-25">
                    <Step1 />
                    <Step2 />
                    <Step3 />
                </div>
