...
import GridGallerySkeleton from "@elements/skeletonLoading/gridGallery/GridGallerySkeleton";

export default function () {
  return (
    <div class="grid w-full [grid-template-columns:repeat(3,_minmax(60px,1fr))]">
      {!Static.showQuestionSkeleton
        ...
        : Array.from({ length: 6 }, (_, index) => <GridGallerySkeleton />)}
    </div>
  );
}
