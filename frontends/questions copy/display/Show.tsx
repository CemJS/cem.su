                          ...
                          <div class="avatar__icon">
                            ...
                            {answer.author.status?.team ? (
                              <img
                                class="avatar__team"
                                src={
                                  answer.author.status?.team ? teamLogo : null
                                }
                              />
                            ) : (
                              <div>
                            ...
                            onclick={(e) => {
                              ...
                              for (let i = 0; i < elemr.length; i++) {
                                for (
                                  ...
                                  if (
                                    elemr[i].childNodes[y].firstChild
                              ...
                              el.parentElement.nextSibling.style =
                                "display: flex";
                          ...
                          return (
                            ...
                            >
                              ...
                              <div class="user-comment__body">
                                <span
                                  init={(e) => (e.innerHTML = comment.text)}
                                ></span>
                              </div>
                              <div class="user-comment__statistic comment-statistic">
                                <div class="comment-statistic__rating">
