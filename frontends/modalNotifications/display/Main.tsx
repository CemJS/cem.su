...
export default function () {
  return (
    <div
      class="fixed left-0 top-0 z-[52] h-full w-full overflow-y-auto overflow-x-hidden bg-gray-800 bg-opacity-90"
      ref="checdiv"
    >
      <div
        class="absolute right-0 z-10 h-full w-full translate-x-full transform overflow-x-hidden transition duration-700 ease-in-out"
        ref="notification"
      >
        <div class="absolute right-0 z-[51] h-screen overflow-y-auto bg-gray-50 p-8 2xl:w-4/12">
          <div class="flex items-center justify-between">
            <p
              tabindex="0"
              class="text-2xl font-semibold leading-6 text-gray-800 focus:outline-none"
            >
              Notifications
            </p>
            <button
              ...
              class="cursor-pointer rounded-md focus:outline-none focus:ring-2 focus:ring-gray-500 focus:ring-offset-2"
              onclick={Func.close}
            >
              <svg
                width="24"
          ...
          <div class="mt-8 flex w-full rounded bg-white p-3">
            <div
              tabindex="0"
              aria-label="heart icon"
              role="img"
              class="flex h-8 w-8 items-center justify-center rounded-full border border-gray-200 focus:outline-none"
            >
              <svg
                width="16"
                height="16"
            ...
            <div class="pl-3">
              <p tabindex="0" class="text-sm leading-none focus:outline-none">
                <span class="text-indigo-700">James Doe</span> favourited an{" "}
                <span class="text-indigo-700">item</span>
              </p>
              <p
                tabindex="0"
                class="pt-1 text-xs leading-3 text-gray-500 focus:outline-none"
              >
                2 hours ago
              </p>
            </div>
          </div>
          <div class="mt-4 flex w-full flex-shrink-0 rounded bg-white p-3 shadow">
            <div
              tabindex="0"
              aria-label="group icon"
              role="img"
              class="flex h-8 w-8 flex-shrink-0 items-center justify-center rounded-full border border-gray-200 focus:outline-none"
            >
              <svg
                width="16"
                height="16"
          ...
          <div class="mt-4 flex w-full rounded bg-white p-3">
            <div
              tabindex="0"
          ...
          <div class="mt-4 flex w-full items-center rounded bg-red-100 p-3">
            <div
              tabindex="0"
              aria-label="storage icon"
              role="img"
              class="flex h-8 w-8 flex-shrink-0 items-center justify-center rounded-full border border-red-200 focus:outline-none"
            >
              <svg
                width="16"
                height="16"
            ...
            <div class="flex w-full items-center justify-between pl-3">
              <p
                tabindex="0"
                class="text-sm leading-none text-red-700 focus:outline-none"
              >
                Low on storage: 2.5/32gb remaining
              </p>
              <p
                tabindex="0"
                class="cursor-pointer text-right text-xs leading-3 text-red-700 underline focus:outline-none"
              >
                Manage
              </p>
            </div>
          ...
          <h2
            tabindex="0"
            class="border-b border-gray-300 pb-2 pt-8 text-sm leading-normal text-gray-600 focus:outline-none"
          >
            YESTERDAY
          </h2>
          <div class="mt-6 flex w-full rounded bg-white p-3">
            <div
              tabindex="0"
              aria-label="post icon"
              role="img"
          ...
          <div class="mt-8 flex w-full items-center rounded bg-green-100 p-3">
            <div
              tabindex="0"
              aria-label="success icon"
              role="img"
              class="flex h-8 w-8 flex-shrink-0 items-center justify-center rounded-full border border-green-200 focus:outline-none"
            >
              <svg
                width="16"
                height="16"
            ...
            <div class="w-full pl-3">
              <div class="flex items-center justify-between">
                <p
                  tabindex="0"
                  class="text-sm leading-none text-green-700 focus:outline-none"
                >
                  Design sprint completed
                </p>
                <p
                  tabindex="0"
                  class="cursor-pointer text-xs leading-3 text-green-700 underline focus:text-indigo-600 focus:outline-none"
                >
                  View
                </p>
              </div>
          ...
          <div class="justiyf-between flex items-center">
            <hr class="w-full" />
            <p
              tabindex="0"
              class="flex flex-shrink-0 px-3 py-16 text-sm leading-normal text-gray-500 focus:outline-none"
            >
              Thats it for now :)
            </p>
            <hr class="w-full" />
