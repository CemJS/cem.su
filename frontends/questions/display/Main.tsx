      ...
      >
        <div class="wrapper wrapper_padding">
          <div class="pt-5">
            ...
            <div class="relative mx-auto mt-[0.9375rem] flex max-w-full flex-wrap items-center justify-between gap-[0.75rem] pb-[6.25rem] @1240:grid @1240:gap-[1.25rem] @1240:[grid-template-columns:repeat(3,1fr)] @1280:mt-5">
              {!Static.showSkeleton ? (
